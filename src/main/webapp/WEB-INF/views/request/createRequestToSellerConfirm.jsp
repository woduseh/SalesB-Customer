<div class="container" style="margin-top:200px">
	...
	<form:form modelAttribute="customerRequestToSellerForm">
		...
		<table  id="requestTable" style="cellspacing: 0; width: 300">
			...
			<tr align="center">
				...
				<td><form:input path="requestName" id="request_title"
						...
						path="requestName" cssStyle="color:red;font-size:small" size="120" />${f:h(CustomerRequestToSellerForm.requestName)}</td>
			</tr>
			<!-- content -->
			<tr align="center">
				...
				<td><form:textarea path="requestContents" rows="5" cols="50"
						...
						size="120" />${f:h(CustomerRequestToSellerForm.requestContents)}</td>
			</tr>
		</table>
