 ...
 */
package handong.capstone2019s.salesb.app.common.constants;
...
public final class MessageId {
    ...
    /**
     * <strong>label.tr.common.english = English</strong>
     */
    public static final String LABEL_TR_COMMON_ENGLISH = "label.tr.common.english";

    
    /**
     * <strong>label.tr.common.adminname = Admin Name</strong>
     */
    public static final String LABEL_TR_COMMON_ADMINNAME = "label.tr.common.adminname";
    ...
    /**
     * <strong>label.tr.menu.adminMenuMessage = Welcome, Admin</strong>
     */
    public static final String LABEL_TR_MENU_ADMINMENUMESSAGE = "label.tr.menu.adminMenuMessage";
    ...
    /**
     * <strong>label.tr.menu.AdminRegisterBtnMessage = Register Admin</strong>
     */
    public static final String LABEL_TR_MENU_ADMINREGISTERBTNMESSAGE = "label.tr.menu.adminRegisterBtnMessage";
    ...
    /**
     * <strong>label.tr.managecustomer.managecustomerMessage = Register Customer</strong>
     */
    public static final String LABEL_TR_MANAGECUSTOMER_MANAGECUSTOMERMESSAGE = "label.tr.managecustomer.managecustomerMessage";

    /**
     * <strong>label.tr.managecustomer.managecustomerMessage = Register Admin</strong>
     */
    public static final String LABEL_TR_MANAGEADMIN_MANAGEADMINMESSAGE = "label.tr.manageadmin.manageadminMessage";
     ...
     * <strong>label.tr.managecustomer.createCompleteMessage = Membership information input -> Confirm information ->
     * <strong>Completed</strong><br>
     * Admin registration was completed. Your "Admin Id" is <strong>{0}</strong>.<br>
     * <strong>Please do not forget because you will need at login.</strong></strong>
     */
    public static final String LABEL_TR_MANAGEDMIN_CREATECOMPLETEMESSAGE = "label.tr.manageadmin.createCompleteMessage";
     ...
     * <strong>label.tr.managecustomer.fullKanaOnlyMessage = Full-width Katakana only</strong>
     */
    public static final String LABEL_TR_MANAGECUSTOMER_ENGLISHONLYMESSAGE = "label.tr.managecustomer.englishOnlyMessage";
    ...
    /**
     * <strong>label.tr.test = test</strong>
     */
    public static final String LABEL_TR_TEST = "label.tr.test";
    
    /**
     * lable_tr_admin_request_form_table_introduce = 최근 요청
     */
    public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_INTRODUCE = "lable_tr_admin_request_form_table_introduce";
    
    /**
     * lable_tr_admin_request_form_table_header_seq = 요청 번호
     */
    public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_SEQ = "lable_tr_admin_request_form_table_header_seq";
    
    /**
     * lable_tr_admin_request_form_table_header_client = 요청인
     */
    public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_CLIENT= "lable_tr_admin_request_form_table_header_client";
    
    /**
     * lable_tr_admin_request_form_table_header_request_name = 요청 제목
     */
    public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_REQUEST_NAME = "lable_tr_admin_request_form_table_header_request_name";
    
    /**
     * lable_tr_admin_request_form_table_header_request_content = 요청 내용
     */
    public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_REQUEST_CONTENT = "lable_tr_admin_request_form_table_header_request_content";
    
    /**
     * lable_tr_admin_request_form_table_header_update_time = 요청 시간
     */
    public static final String LABEL_TR_ADMIN_REQUEST_FORM_TABLE_HEADER_UPDATE_TIME = "lable_tr_admin_request_form_table_header_update_time";
    
    /**
     * lable_tr_no_result = 검색 결과가 없습니다!
     */
    public static final String LABEL_TR_NO_RESULT = "lable_tr_no_result";
    
    /**
     * lable_tr_menu_no_result = 최근 1주일 내에 받은 요청이 없습니다.
     */
    public static final String LABLE_TR_MENU_NO_RESULT = "lable_tr_menu_no_result";
    
    
    /**
     * label_tr_menu_store_manage = store manage
     */
    public static final String LABEL_TR_MENU_STORE_MANAGE = "label_tr_menu_store_manage";
    
    
    /**
     * label_tr_menu_request_manage = request list
     */
    public static final String LABEL_TR_MENU_REQUEST_MANAGE = "label_tr_menu_request_manage";
    
    /**
     * label_tr_menu_return = Return to Main
     */
    public static final String LABEL_TR_MENU_RETURN = "label_tr_menu_return";
